...
const dataPath = __dirname + "/Sananu/approvedThreads.json";
const dataPending = __dirname + "Sananu/pendingdThreads.json";
const fs = require("fs");
